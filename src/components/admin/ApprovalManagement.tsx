...
import { ShieldCheck, CheckCircle, XCircle, Clock, FileText, Settings, Box, RefreshCw } from 'lucide-react';
...
export default function ApprovalManagement() {
  ...
  useEffect(() => {
    fetchApprovals();
    const interval = setInterval(fetchApprovals, 30000); // 30 sec polling
    ...
    <div className="w-full flex flex-col gap-6 text-[#f7dec4]">
      <div className="flex justify-between items-start">
        ...
        <button 
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-4 py-2 bg-[#120a06]/80 text-[#f8bc51] border border-[#f8bc51]/40 rounded-lg hover:bg-[#302117]/80 transition-colors font-mono text-[10px] uppercase tracking-widest"
        >
