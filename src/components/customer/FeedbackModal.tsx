      ...
      >
        <motion.div
          ...
          style={{
            ...
            background: 'linear-gradient(180deg, #1a1208 0%, #0e0b07 100%)',
            ...
            {submitted ? (
              ...
              <motion.div key="rating" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                <div style={{ marginBottom: 24 }}>
                  <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 6 }}>
                    Rate your order
                  </p>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: 12, marginBottom: 12 }}>
                  {[1, 2, 3, 4, 5].map(star => (
                    <motion.button
                      ...
                      style={{
                        ...
                        filter: star <= activeStar
                          ? 'drop-shadow(0 0 8px rgba(212,163,84,0.7))'
                          : 'none',
                    ...
                    >
                      <Star
                        size={38}
                        fill={star <= activeStar ? '#d4a354' : 'transparent'}
                        color={star <= activeStar ? '#d4a354' : 'rgba(255,255,255,0.2)'}
                        strokeWidth={1.5}
                      />
                    </motion.button>
                  ))}
                  ...
                  <AnimatePresence mode="wait">
                    {activeStar > 0 && (
                      <motion.p
                        ...
                        exit={{ opacity: 0, y: -6 }}
                        style={{ color: '#d4a354', fontSize: 14, fontWeight: 600 }}
                      >
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  <textarea
                    ...
                    onFocus={e => (e.target.style.borderColor = 'rgba(212,163,84,0.4)')}
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    background: selectedStar > 0
                      ? 'linear-gradient(135deg, #c49040, #d4a354)'
                      : 'rgba(255,255,255,0.06)',
                    color: selectedStar > 0 ? '#1b1208' : 'rgba(255,255,255,0.25)',
                    transition: 'all 0.3s',
